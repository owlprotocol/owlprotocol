import type { AssetBasketInput } from "@owlprotocol/contracts/lib/types/utils/AssetLib";
...
/** @internal */
export function validateIdAssetRouterInputBasket({
    networkId,
    address,
    basketId,
    assetAddress,
...
export function toPrimaryKeyAssetRouterInputBasket({
    networkId,
    address,
    basketId,
    assetAddress,
...
/** @internal */
export function validateAssetRouterInputBasket(item: AssetRouterInputBasket): AssetRouterInputBasket {
    const item2: AssetRouterInputBasket = {
        ...item,
        ...validateIdAssetRouterInputBasket(item),
    };
...
export function assetRouterInputBasketsFromSolidityBasket(
    ...
    return upserts.map(validateAssetRouterInputBasket);
}
