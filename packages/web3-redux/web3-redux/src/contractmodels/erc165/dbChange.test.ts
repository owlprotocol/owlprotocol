...
import { ContractCustomDexie } from "@owlprotocol/web3-dexie";
...
describe(`${ERC165Name}/sagas/dbChange.ts`, () => {
    ...
    describe("ERC721", () => {
        ...
        it("ERC721", async () => {
            ...
            //Balance
            const returnValue = await ContractCustomDexie.IERC721.callDB.balanceOf(networkId, ERC721Mintable.address, [
                ADDRESS_1,
            ]);
