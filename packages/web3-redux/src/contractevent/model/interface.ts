...
export type ContractEventIndexInput =
    ...
    | { topic0: string, topic2: string, topic3: string }
    | { topic0: string, topic1: string, topic3: string }
    | { topic0: string, topic1: string }
    | { topic0: string, topic2: string }
    | { topic0: string, topic3: string }
    | { topic0: string }
