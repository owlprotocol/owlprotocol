...
export type EthLogSubscribeIndexInput =
    | EthLogSubscribeId
    | { networkId: string }
...
/*
| { networkId: string; address: string, eventFormatFull: string, topic1: string, topic2: string }
| { networkId: string; address: string, eventFormatFull: string, topic2: string, topic3: string }
| { networkId: string; address: string, eventFormatFull: string, topic1: string, topic3: string }
| { networkId: string; address: string, eventFormatFull: string, topic1: string }
| { networkId: string; address: string, eventFormatFull: string, topic2: string }
| { networkId: string; address: string, eventFormatFull: string, topic3: string }
*/

export const EthLogSubscribeIndex =
...
export function toPrimaryKeyEthLogSubcribe({
    networkId,
    address,
    topic0,
    topic1,
