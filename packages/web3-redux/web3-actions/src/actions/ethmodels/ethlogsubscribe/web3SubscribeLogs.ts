...
import { WithFilter, WithTopicsArr, EthLogFilterPartial, validateEthLogFilter } from "@owlprotocol/web3-models";
...
web3SubscribeLogsAction.match = (action: AnyAction) => action.type === WEB3_SUBSCRIBE_LOGS;
web3UnsubscribeLogsAction.match = (action: AnyAction) => action.type === WEB3_UNSUBSCRIBE_LOGS;
