...
/** @internal */
export function validateIdEthTransaction({ networkId, hash }: EthTransactionId): EthTransactionId {
    return { networkId, hash };
}

export function toPrimaryKeyEthTransaction({ networkId, hash }: EthTransactionId): [string, string] {
    return [networkId, hash];
}

/** @internal */
export function validateEthTransaction(item: EthTransaction): EthTransaction {
