import { put, call, select /*takeEvery, actionChannel, all, spawn*/ } from "typed-redux-saga";
/*
...
import { EthCallCRUDActions, Web3CallActionInputBase, web3CallAction } from "@owlprotocol/web3-actions";
import { EthCall, EthCallStatus, WithArgs, validateEthCall /*WithArgs*/ } from "@owlprotocol/web3-models";
import { Web3CallAction /*web3CallAction , Web3CallActionInputBase, WEB3_CALL*/ } from "@owlprotocol/web3-actions";
//import { web3CallBatchedAction, Web3CallBatchedAction, WEB3_CALL_BATCHED } from "@owlprotocol/web3-actions";
...
export function* web3CallSaga<Args extends any[] = any[], Ret = any>(
    ...
    const dbSelected = yield* call(EthCallDexie.get, { networkId, to, data });
    ...
    //yield* put(EthCallCRUDActions.actions.upsert(ethcallLoading, action.meta.uuid));
    ...
    try {
        ...
        yield* put(EthCallCRUDActions.actions.upsert(ethcall, meta.uuid, meta.ts));
        return ethcall;
    } catch (err) {
        const ethcall = validateEthCall({
            ...payload,
