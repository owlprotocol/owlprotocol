...
import { ERC721TopDownDnaDeploy, ERC721TopDownDnaDeployParams } from '../../../deploy/assets/ERC721/ERC721TopDownDna.js';
...
const deploy = async ({ ethers, network, deployments }: HardhatRuntimeEnvironment) => {
    ...
    const results = await ERC721TopDownDnaDeploy({
        provider: ethers.provider, signers, network,
        tokens, balanceTarget: 10
    });
