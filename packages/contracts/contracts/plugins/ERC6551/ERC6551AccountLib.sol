...
//from https://github.com/erc6551/reference/blob/main/src/lib/ERC6551AccountLib.sol
library ERC6551AccountLib {
    function computeAddress(
        ...
        return Create2Upgradeable.computeAddress(bytes32(_salt), bytecodeHash, registry);
    }
