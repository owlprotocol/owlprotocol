...
import {ERC721TopDownVaultLib, Unauthorized, AddressNotChild} from "./ERC721TopDownLib.sol";

/**
 * @dev Vault for tracking ownership of specific ERC721/ERC1155/(ERC20) by ERC6551 token bound accounts.
 * Users can use the following to make deposits:
 * - ERC721 safeTransfer to vault
 * - ERC1155 transfer to vault
 * - ERC1155 batchTransfer to vault
 * - deposit() function (requires approvals but can batch transfer from multiple assets)
 */
contract ERC721TopDownVault is IERC721TopDownVault, IERC721ReceiverUpgradeable, IERC1155ReceiverUpgradeable {
     ...
     */
    function __ERC721TopDownVault_init_unchained(
        address[] memory _childContracts721,
        address[] memory _childContracts1155
    ) internal {
    ...
    function onERC1155BatchReceived(
        ...
        //Self-transfer, approve
        if (operator == address(this)) return IERC1155ReceiverUpgradeable.onERC1155BatchReceived.selector;
