...
import { ContractActionHelpers, inferInterfaceAction, NetworkCRUDActions } from "@owlprotocol/web3-actions";

import { ContractDexieHelpers, ERC165Dexie, EthCallDexie } from "@owlprotocol/web3-dexie";
...
describe(`${ERC165Name}/sagas/inferInterface.ts`, () => {
    ...
    describe("infer", () => {
        ...
        it("ERC721 ownerOf, ERC721Metadata tokenUri", async () => {
            ...
            const addAction = ContractActionHelpers.IERC165.supportsInterface({
                networkId,
